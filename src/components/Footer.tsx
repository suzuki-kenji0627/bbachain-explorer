...
export const Footer: FC = () => {
  ...
  return (
    <div className="relative mb-0 mt-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-2 md:gap-8 md:space-x-12 relative">
            <div className='flex flex-col col-span-2 mx-4 items-center md:items-start'>
              <div className='flex flex-row ml-1'>
                <Link href={fmtUrlWithCluster('/')} target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                  <div className='flex flex-row ml-1'>
                    <Image
                      src="/images/logo.png"
                      alt="bbascan"
              ...
              <div className="flex md:ml-2">
                ...
                <a href="https://github.com/bbachain"  type="button" className="border-white text-secondary hover:text-white leading-normal hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
                  <svg aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
                    data-icon="github"
            ...
            <div className="mb-6 items-center mx-auto max-w-screen-lg">
              <div className="font-normal capitalize mb-2.5">BBACHAIN</div>

              <div className="flex flex-col mb-0 gap-2">
                <Link href="https://bbachain.com" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                  Project
                </Link>
              </div>
            </div>
            ...
            <div className="mb-6 items-center mx-auto max-w-screen-lg">
              ...
              <div className="flex flex-col mb-0 gap-2">
                <Link href="https://docs.bbachain.com" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                  Documentation
                </Link>
              </div>
            </div>
            ...
            <div className="mb-6 items-center mx-auto max-w-screen-lg">
              ...
              <div className="flex flex-col mb-0 gap-2">
                <Link href="https://bbachain.com/news" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                  News
                </Link>
              </div>
            </div>
